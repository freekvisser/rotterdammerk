...
final class Version202608031837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS stock (product_id CHAR(36) NOT NULL, amount INT DEFAULT NULL, PRIMARY KEY (product_id), UNIQUE KEY id_UNIQUE (product_id), CONSTRAINT FK_stock_product FOREIGN KEY (product_id) REFERENCES product (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci`');
    }
